...
@section('content')
    <div class="content-wrapper">
        <section>
            <div class="content">
                <div class="container">
                    <h2 class="mb-3 mt-3">Bloq rəyləri</h2>
                                        ...
                                        <td>
                                            <ul class="list-inline m-0">
                                                <li class="list-inline-item">
                                                    <a href="{{ route('blog_comment.show', $blog_comment->id) }}">
                                                ...
                                                <li class="list-inline-item">
                                                    <a href="{{ route('blog_comment.edit', $blog_comment->id) }}">
                                                ...
                                                <li class="list-inline-item">
                                                    <form action="{{ route('blog_comment.destroy', $blog_comment->id) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('DELETE')
