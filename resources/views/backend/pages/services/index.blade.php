...
@section('content')
    <div class="content-wrapper">
        <section>
            <div class="content">
                <div class="container">
                    <h2 class="mb-3 mt-3">Xidmətlərimiz</h2>
                    <div class="card-header mt-0">
                        <div class="card-tools">
                            <div class="input-group input-group-sm" style="width: 150px;">
                                <div class="input-group-append">
                                    <a href="{{ route('serviceback.create') }}"><i class="fa fa-plus"
                        ...
                        <table class="table custom-table">
                            ...
                            <tbody>
                                @foreach ($services as $service)
                                    <tr scope="row">
                                        <td>{{ $service->id }}</td>
                                        <td><img src="{{ asset('frontend/services/images/' . $service->image) }}"
                                                alt="" height="100" width="100"></td>
                                        <td><img src="{{ asset('frontend/services/icons/' . $service->icon) }}"
                                                alt="" height="100" width="100"></td>
                                        <td>{{ $service->title }}</td>
                                        ...
                                        <td>
                                            <ul class="list-inline m-0">
                                                <li class="list-inline-item">
                                                    <a href="{{ route('serviceback.show', $service->id) }}">
                                                ...
                                                <li class="list-inline-item">
                                                    <a href="{{ route('serviceback.edit', $service->id) }}">
                                                ...
                                                <li class="list-inline-item">
                                                    <form action="{{ route('serviceback.destroy', $service->id) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('DELETE')
